...
app.service('PPODService',function($http,url,$window,$timeout,sharedProperties,$cordovaPush,$rootScope,$state,myCache,$ionicPopup,$cordovaSQLite){    
	...
	function createTable(tx){
		...
		tx.executeSql('CREATE TABLE IF NOT EXISTS tnet_notification_details(notify_id INTEGER NOT NULL PRIMARY KEY, notify_guid TEXT NOT NULL, notify_date TEXT NOT NULL, notify_type TEXT NOT NULL, notify_msg TEXT NOT NULL, entity_guid TEXT NOT NULL)',[],nullHandler,errorHandlerQuery);
	};
